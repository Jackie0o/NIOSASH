(() => {
    ...
    (() => {
        ...
        function createSlider(selector, config) {
            if (document.querySelector(selector)) return new swiper_core_Swiper(selector, config);
        }
        const baseConfig = {
            observer: true,
            observeParents: true,
        ...
        function initSliders() {
            ...
            createSlider(".pros__slider-reverse", {
                ...baseConfig,
                modules: [ Pagination ],
                pagination: {
            ...
            createSlider(".history__slider", {
                ...
                on: {
                    init: () => handleHoverEffects(".history__slide")
                }
            });
            createSlider(".reviews__slider", {
                ...baseConfig,
                modules: [ Navigation, Pagination ],
                pagination: {
            ...
            if (document.querySelector(".our-history__slider") && document.querySelector(".our-history__nav")) {
                ...
                const ourHistorySwiper = new swiper_core_Swiper(".our-history__slider", {
            ...
            const teachersImgs = createSlider(".teachers__imgs", {
                ...baseConfig,
                slidesPerView: 1.05,
            ...
            const teachersSlider = createSlider(".teachers__slider", {
                ...baseConfig,
        ...
        function handleHoverEffects(slideSelector) {
